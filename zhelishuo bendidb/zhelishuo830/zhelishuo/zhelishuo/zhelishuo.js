...
import zhelishuoxijie from './zhelishuoxijie';
...
function shigefn(){
  ...
  return(
    ...
    <Stack.Screen name="热门细节" component={zhelishuoxijie}  mode="modal" headerMode="none"/>
    <Stack.Screen name="搜索" component={search}  mode="modal" headerMode="none"/>
    </Stack.Navigator>
);
}
...
function remen({navigation}){
  ...
  return (
    <View>
      ...
      <TouchableWithoutFeedback style={{position:'absolute',right:10}} onPress={()=>{ navigation.navigate("搜索")}}>
