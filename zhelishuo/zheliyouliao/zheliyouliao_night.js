...
function MyCarousel({ navigation }) {
  ...
  return (
    ...
    <View style={{ backgroundColor:"#444444"  }}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: "100%", height: 50, backgroundColor: '#666666', borderBottomLeftRadius: 20, borderBottomRightRadius: 20, elevation: 5 }}>
        <View>
        ...
        <Text style={{ fontFamily: "youran",fontSize: 30,color: 'white'}}>浙里有料</Text></View>
      ...
      <ScrollView style={{ marginBottom: 50 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.container}>
          <TouchableOpacity onPress={goForward}>
            <Text style={{
              fontSize: 24, marginLeft: 26, marginTop: 15, marginBottom: 10,
              textShadowRadius: 2,color: 'white',
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ flexDirection: "row", marginLeft: 10, marginTop: 10, marginBottom: 20 }}>
          ...
          <TouchableOpacity style={{ marginLeft: 20 }} onPress={() => {
            ...
            <Text style={{ marginTop: 10, marginLeft: 15, color: 'white' }}>卷中有诗</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={{ marginLeft: 20 }} onPress={() => {
            ...
            <Text style={{ marginTop: 10, marginLeft: 15, color: 'white' }}>拼图成画</Text>
          ...
          <TouchableOpacity style={{ marginLeft: 20 }} onPress={() => {
            ...
            <Text style={{ marginTop: 10, marginLeft: 15,color: 'white'  }}>腹中有墨</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={{ marginLeft: 20 }} onPress={() => {
            ...
            <Text style={{ marginTop: 10, marginLeft: 15, color: 'white' }}>汉服有购</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={{ marginLeft: 20 }} onPress={() => {
            ...
            />
            <Text style={{ marginTop: 10, marginLeft: 15, color: 'white' }}>古风鉴赏</Text>
          </TouchableOpacity>
