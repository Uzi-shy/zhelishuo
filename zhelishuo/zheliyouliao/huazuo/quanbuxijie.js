...
<ScrollView style={{marginLeft:15,marginRight:15,marginBottom:125}}  showsVerticalScrollIndicator={false}>
    <View style={{alignItems:'center'}}>
                        <Text style={{fontSize:30,fontWeight:'bold',marginBottom:10,marginTop:20}} selectable={true}>{nm}</Text>
    ...
    <Text style={{fontSize:25,fontWeight:'700',marginBottom:8}}>赏析</Text>
