    ...
    return (
      <View >
        ...
        <View >
          ...
          <ScrollView showsVerticalScrollIndicator={false} style={{ marginVertical: 5, marginHorizontal: 5,height:620 }}>{/* 按钮栏目 */}
          <View>
                        ...
                        <View>
                          <View>
                            <View style={styles.item} style={{
                              ...
                              <Text style={{ padding:5,width: itemWidth+20,fontSize: 12, marginVertical: 5 }}>{item.title}</Text>
                            ...
                            <View style={styles.item} style={{
                              ...
                              <TouchableOpacity onPress={() => {
                                ...
                                <Image
                                  // onLoadStart={() => { this.setSize(item.pick[0]) }}
                                  source={{ uri: item.pick[0] }}
                                  style={{  width: itemWidth+20, height: item.hight,borderTopLeftRadius: 5,borderTopRightRadius: 5 }}
                                />
                              </TouchableOpacity>
                              <Text style={{ width: itemWidth+20,fontSize: 12, marginVertical: 5 }}>{item.title}</Text>
                              <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center',padding:5 }}>
                                  <Image style={{ height: 20, width: 20, borderRadius: 400,marginRight:5 }} source={{ uri: item.gerenxx[0].toux.uri }} />
                                  <Text style={{fontSize:10}}>{item.gerenxx[0].name}</Text>
