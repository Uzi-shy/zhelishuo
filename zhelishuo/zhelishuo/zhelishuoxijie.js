    ...
    return (
      ...
      <View style={{ flex: 1 }}  >
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', height: 65, width: '100%', alignItems: 'center', backgroundColor: 'white' }}>
          ...
          <View style={{ flexDirection: 'row', marginLeft: 5, marginTop: 15,width:"100%",alignItems:'center' }}>

            <TouchableOpacity style={{ marginLeft: 5, width: 40, height: 40, borderRadius: 400 }}>
              <Image source={{ uri: route.params.toux }} style={{ width: 30, height: 30, borderRadius: 400 }} />

            </TouchableOpacity>
            <Text style={{ fontSize: 15, marginLeft: 8, alignItems: 'center' }}>{route.params.name}</Text>
            <TouchableOpacity style={{
              width: 60,
              height: 30,
              borderRadius: 20,
        ...
        <View style={{ flex: 1, marginBottom: 40 }}>
          <ScrollView   >
            ...
            <View style={{ padding: 10 }}>
              <Text style={{ fontSize: 17, }}>{route.params.words}</Text>
            </View>
